  ...
  window.targetLightbox,
    $(document)
      .on('click', '[data-lightbox]', function (t) {
        ...
        1 == i && (n = 'autoplay')
        var s = $(
          '<div id="lightbox-modal" class="modal fade" tabindex="0"><div class="modal-dialog"><div class="modal-content ' +
            l +
            ' blocs-lb-container"><button id="blocs-lightbox-close-btn" type="button" class="close-lightbox" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><div class="modal-body"><a href="#" class="prev-lightbox" aria-label="prev">' +
            require('@fortawesome/fontawesome-free/svgs/solid/chevron-left.svg')
              .default +
            '</a><a href="#" class="next-lightbox" aria-label="next">' +
            require('@fortawesome/fontawesome-free/svgs/solid/chevron-right.svg')
              .default +
            '</a><img id="lightbox-image" class="img-responsive" src="' +
            e +
  ...
  $(window).on('keydown', function (t) {
    37 == t.which
      ? $('.prev-lightbox').is(':visible') &&
        $('.prev-lightbox').trigger('click')
      : 39 == t.which &&
        $('.next-lightbox').is(':visible') &&
        $('.next-lightbox').trigger('click')
  })
}
